...
import { useUserSubScriptionTable } from "@composables/userSubScriptions/useUserSubScriptionTable";
...
const editPermission = computed(() =>
  permissionStore.hasPermission("userSubScriptions.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("userSubScriptions.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("userSubScriptions.delete")
);
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("userSubScriptions.title") }}</h1>
