...
import { useOwnLicenseTable } from "@composables/ownLicenses/useOwnLicenseTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("ownLicenses.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("ownLicenses.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("ownLicenses.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("ownLicenses.delete")
);
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("ownLicenses.title") }}</h1>
