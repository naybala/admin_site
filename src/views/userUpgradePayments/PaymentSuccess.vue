...
<template>
  <div class="min-h-60 flex items-center justify-center">
    <div class="container">
      ...
      <p class="details">Thank you for subscription for our system</p>
      <p class="text-black">
        Now you are upgraded,if not effect , please logout and login again
      </p>
      <br />
      <Button
        label="OK"
