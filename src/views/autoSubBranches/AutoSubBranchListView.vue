...
import { useAutoSubBranchTable } from "@composables/autoSubBranches/useAutoSubBranchTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("autoSubBranches.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("autoSubBranches.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("autoSubBranches.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("autoSubBranches.delete")
);

const tableColumns = [
  { label: "name", field: "name" },
  { label: "autoType", field: "autoType" },
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("autoSubBranches.title") }}</h1>
