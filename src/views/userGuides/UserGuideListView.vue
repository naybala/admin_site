...
import { useUserGuideTable } from "@composables/userGuides/useUserGuideTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("userGuides.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("userGuides.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("userGuides.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("userGuides.delete")
);

const tableColumns = [
  { label: "title", field: "title" },
  { label: "youtube_link", field: "youtube_link" },
];
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("userGuides.title") }}</h1>
