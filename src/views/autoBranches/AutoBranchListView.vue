...
import { useAutoBranchTable } from "@composables/autoBranches/useAutoBranchTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("autoBranches.store")
);
const editPermission = computed(() => permissionStore.hasPermission("autoBranches.edit"));
const showPermission = computed(() => permissionStore.hasPermission("autoBranches.show"));
const deletePermission = computed(() =>
  permissionStore.hasPermission("autoBranches.delete")
);
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("autoBranches.title") }}</h1>
