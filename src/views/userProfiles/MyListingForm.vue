...
import { useMyPropertyForm } from "@composables/userProfiles/useMyPropertyForm";
...
import MyListingShow from "./MyListingShow.vue";
      ...
      <template #content>
        ...
        <form v-else @submit.prevent="save">
          <span v-if="isShowMode">
            <MyListingShow v-if="form" :data="displayData" />
          </span>
