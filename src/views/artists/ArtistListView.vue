...
import { useArtistTable } from "@composables/artists/useArtistTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("artists.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("artists.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("artists.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("artists.delete")
);

const tableColumns = [
  { label: "url", field: "url", isImage: true },
  { label: "name", field: "name" },
  { label: "enName", field: "enName" },
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("artists.title") }}</h1>
