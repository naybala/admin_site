...
import { useSocialCategoryTable } from "@composables/socialCategories/useSocialCategoryTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("socialCategories.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("socialCategories.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("socialCategories.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("socialCategories.delete")
);
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("socialCategories.title") }}</h1>
