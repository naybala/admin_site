...
import { useSocialAudioTable } from "@composables/socialAudios/useSocialAudioTable";
...
const createPermission = computed(() =>
  permissionStore.hasPermission("socialAudios.store")
);
const editPermission = computed(() =>
  permissionStore.hasPermission("socialAudios.edit")
);
const showPermission = computed(() =>
  permissionStore.hasPermission("socialAudios.show")
);
const deletePermission = computed(() =>
  permissionStore.hasPermission("socialAudios.delete")
);
...
const tableColumns = [
  ...
  { label: "countryId", field: "countryId" },
];
...
<template>
  <div class="p-0 md:p-6">
    <h1 class="text-3xl font-bold mb-6">{{ t("socialAudios.title") }}</h1>
